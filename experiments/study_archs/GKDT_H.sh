...
# login to a running job: srun --jobid=314461 -w dgx-24 --overlap --pty bash -i
...
cd '/project/vonneumann1/cl2025/GKD_github'
echo $(pwd)
...
srun torchrun \
    ...
    main_gkd.py --cfg_file /project/vonneumann1/cl2025/GKD_github/experiments/configs/gkd.yaml \
    OUTPUT_DIR /project/vonneumann1/cl2025/GKD_github/output/GKDT_H \
